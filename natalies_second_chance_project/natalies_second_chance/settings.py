"""
Django settings for natalies_second_chance project.
...
WSGI_APPLICATION = 'natalies_second_chance.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'natalies_second_chance/static')
]
